<template>
  <div>
    <van-tabbar v-model="active" active-color="#fb763a" inactive-color="#000">
      <van-tabbar-item to="/film">
        <span class="iconfont icon-dianyingzhiye-dianyingbang" slot="icon"></span>
        <span>电影</span>
      </van-tabbar-item>
      ...
      <van-tabbar-item to="/ucenter">
        <span class="iconfont icon-wodewo" slot="icon"></span>
        <span>我的</span>
      </van-tabbar-item>
    </van-tabbar>
  </div>
